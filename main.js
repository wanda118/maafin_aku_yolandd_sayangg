...
const messages = [
    ...
    "haii yolanddd",
    "kamu masih marah ya?",
    "iya sih gara gara aku banyak ngekang kamu hehe",
    "aku ga gitu lagi kok :(",
    "hehe maafin aku ya aku ga gitu lagi kokkkkk yolannddd",
    "aku ga akan ngajak vc atau call jugaaaaa",
    "udah ya bloknya :(",
    "ayo kaya dulu lagi yaaa",
    "sayangkuu",
    "cintaakuuu",
    "and more than everything",
    "udah cukup kata kata sampahku hehee",
    "coba sayang pencet",
    "coba sekali lagi aku mau ngomong penting bangett buat sayang yolandddd ",
    "aku cuma mau bilang",
    "kesupen jemput kamu",
    "i love you❤️",
    "hahahahaha",
